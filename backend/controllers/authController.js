...
const verifySignature = async (req, res) => {
  try {
    ...
    if (!employee) {
      ...
      // Note: phong_ban_id is NOT set by default - employee must join a department first
      employee = new HoSoNhanVien({
        employee_did: employeeDid,
        walletAddress: walletAddress.toLowerCase(),
        wallet_verified: true,
        chuc_vu: 'Intern', // Default role
        // phong_ban_id: null - Employee must join a department through test or assignment
